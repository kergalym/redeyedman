...
class ViewdashSearch(ViewDash):

    @app.route('/adminboard/adminboard_main/', methods=['POST'])
    @login_required
    def search_dasboard_main(self):
    ...
    @login_required
    def search_dasboard_category(self):
    ...
    @login_required
    def search_dasboard_inner(self):
    ...
    @login_required
    def search_dasboard_users(self):
